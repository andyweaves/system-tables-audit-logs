...
<table border="0" class="dataframe">
  ...
  <tbody>
    ...
    <tr>
      <td style="background-color: white; color: black;font-family: Century Gothic, sans-serif;font-size: medium;text-align: left;padding: 0px 20px 0px 0px;width: auto">high_number_of_reads_writes</td>
